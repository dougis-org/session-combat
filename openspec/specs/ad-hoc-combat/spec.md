...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-08-27-add-in-progress-campaign-banner/design.md) document, not a replacement.
