...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-09-05-storage-refactor-close-gaps/design.md) document, not a replacement.
