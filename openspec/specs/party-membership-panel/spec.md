...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-07-07-party-membership-panel/design.md) document, not a replacement.
