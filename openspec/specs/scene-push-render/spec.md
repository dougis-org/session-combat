...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-06-28-issue-319-scene-push-render/design.md) document, not a replacement.
