...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-09-20-validate-session-post-body/design.md) document, not a replacement.
