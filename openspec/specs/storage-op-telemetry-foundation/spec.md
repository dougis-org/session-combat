...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-08-23-storage-runop-telemetry-foundation/design.md) document, not a replacement.
