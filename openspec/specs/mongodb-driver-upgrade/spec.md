...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-09-21-upgrade-mongodb-driver-v7/design.md) document, not a replacement.
