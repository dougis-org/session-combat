...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-08-31-decouple-parties/design.md) document, not a replacement.
