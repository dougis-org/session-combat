...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-08-24-campaign-encounter-link-api/design.md) document, not a replacement.
