...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-09-02-add-death-saving-throws/design.md) document, not a replacement.
