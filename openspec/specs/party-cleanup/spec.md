...
This document details *changes* to requirements and is additive to the `../../changes/archive/2026-06-08-party-builder-shared-characters/design.md` document, not a replacement.
