...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-06-15-extract-monster-stat-editor/design.md) document, not a replacement.
