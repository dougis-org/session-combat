...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-06-14-client-use-campaign-stream-hook/design.md) document, not a replacement.
