...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-08-26-campaign-nav-fix-and-encounter-tests/design.md) document, not a replacement.
