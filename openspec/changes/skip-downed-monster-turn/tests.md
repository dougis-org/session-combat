...
- [x] **TC1 — Monster at 0 HP is skipped.** Task: T1, T2. Spec scenario:
...
- [x] **TC2 — Consecutive downed monsters are all skipped.** Task: T2.
...
- [x] **TC3 — Player at 0 HP keeps their turn.** Task: T1. Spec scenario:
...
- [x] **TC4 — Lair combatant is never skipped.** Task: T1. Spec scenario:
...
- [x] **TC5 — Skip crosses the round wrap.** Task: T2. Spec scenario:
...
- [x] **TC6 — Every remaining combatant is a downed monster: no-op +
...
- [x] **TC7 — Legendary-action pool reset targets only the final landing
...
- [x] **TC8 — Healed monster resumes its normal turn.** Task: T2. Spec
...
- [x] **TC9 — Defensive: empty/degenerate combatants list does not
...
- [x] **TC10 — Baseline regression: normal turn advance among all-live
