...
- **THEN** its `encounters` array contains at least the minimum encounter count per campaign documented in [`populate-campaigns-g3/spec.md`](./populate-campaigns-g3/spec.md)
