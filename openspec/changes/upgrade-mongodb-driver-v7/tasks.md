...
- [ ] Confirm acceptance criteria are covered: cross-check each of the 6 scenarios across the 5 "ADDED Requirement" sections in `specs/mongodb-driver-upgrade/spec.md` against the tests/tasks above — all 6 must have a corresponding test or verification step before proceeding.
