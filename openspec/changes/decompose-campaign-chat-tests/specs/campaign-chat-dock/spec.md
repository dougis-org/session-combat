...
- **Then** all 13 dock shell tests in [`tests/unit/components/CampaignChat/CampaignChat.drawer.test.tsx`](file:///home/doug/dev3/session-combat/tests/unit/components/CampaignChat/CampaignChat.drawer.test.tsx) pass without modification to their original assertions.
