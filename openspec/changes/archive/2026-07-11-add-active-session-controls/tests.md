...
### T4 — Reactive SSE integration coverage (extend `tests/unit/components/CampaignChat/CampaignChat.scene.test.tsx`-style harness or a new `tests/unit/components/SessionControlReactive.test.tsx`)
