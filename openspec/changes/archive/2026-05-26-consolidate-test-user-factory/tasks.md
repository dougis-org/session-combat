...
- [ ] Archive the change: move `openspec/changes/consolidate-test-user-factory/` to `openspec/changes/archive/2026-05-26-consolidate-test-user-factory/` — stage both copy and deletion in a single commit
- [ ] Confirm `openspec/changes/archive/2026-05-26-consolidate-test-user-factory/` exists and `openspec/changes/consolidate-test-user-factory/` is gone
- [ ] **Create a doc branch**: `git checkout -b doc/archive-2026-05-26-consolidate-test-user-factory` then `git push -u origin doc/archive-2026-05-26-consolidate-test-user-factory`
- [ ] Open a PR from the doc branch to `main` with title `docs: archive consolidate-test-user-factory (2026-05-26)`
